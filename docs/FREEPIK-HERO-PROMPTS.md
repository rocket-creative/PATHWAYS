# Freepik AI Image Prompts - Hero Images
...
To match the Pathways Within brand without looking uniform/cult-like:

**Primary Tones (mix and match):**
- Soft cream / oatmeal / beige
- Warm taupe / sand
- Muted sage green
- Soft dusty rose / blush
- Light chambray blue
- Warm terracotta / clay
- Soft white / off-white

**Fabric Styles:**
- Natural textures (linen, cotton, knit)
- Casual but polished
- Layered, relaxed fits
- NO matching outfits - varied but harmonious
...
|---|----------|-------------|----------|
| 1 | Homepage | Diverse group (3-4 people), warm, welcoming | 🔴 HIGH |
| 2 | Homepage Alt | Different diverse group composition | 🟡 MEDIUM |
| 3 | Therapy - Individual | Single person, reflective, peaceful | 🔴 HIGH |
| 4 | Therapy - Couples | Two people, connection, trust | 🔴 HIGH |
| 5 | Therapy - Family | Parent + child/teen moment | 🟡 MEDIUM |
| 6 | Wellness - Spa | Relaxation, serene, self-care | 🔴 HIGH |
| 7 | Wellness - Beauty | Healthy, glowing, vitality | 🟡 MEDIUM |
| 8 | About - Team | Professionals, approachable | 🟡 MEDIUM |
| 9 | Community | Support group feeling | 🟢 LOW |
| 10 | Getting Started | Welcoming, inviting person | 🔴 HIGH |
| 11 | Getting Started Alt | Person walking forward | 🟢 LOW |
| 12 | General Lifestyle 1 | Spare/flexible use | 🟢 LOW |
| 13 | General Lifestyle 2 | Spare/flexible use | 🟢 LOW |

**Minimum for Launch:** Images 1, 3, 4, 6, 10 (5 images)
**Recommended:** All HIGH + MEDIUM priority (8-10 images)
**Full Set:** All 13 images
...
### DO:
✅ Generate multiple variations of each prompt  
✅ Pick images where people look natural, not stiff  
...
When generating on Freepik AI:
- **Aspect Ratio:** Portrait (or Custom 3:4)
- **Style:** Photography / Editorial / Lifestyle
- **Quality:** High
- **Generate:** 4 variations per prompt, pick best
...
Save images as:
```
hero-homepage-diverse-group-01.jpg
hero-therapy-individual-01.jpg
hero-therapy-couples-01.jpg
hero-wellness-spa-01.jpg
hero-wellness-beauty-01.jpg
hero-about-team-01.jpg
hero-getting-started-01.jpg
```

Place in: `/public/hero-images/`
...
*For: Pathways Within Hero Images*
