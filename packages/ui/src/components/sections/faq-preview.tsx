 ...
 */
export function FAQPreview({ site = 'main' }: FAQPreviewProps) {
  const { ref, isVisible } = useScrollAnimation()
  const [openIndex, setOpenIndex] = useState<number | null>(0)
  const faqUrl = site === 'main' ? '/faq' : `${SITE_CONFIG.main.url}/faq`
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          >
            ...
            {site === 'main' ? (
              ...
              <a href={faqUrl} className="btn-pill btn-pill-secondary">
                <span className="btn-text">View all FAQs</span>
                <span className="btn-arrow"><ArrowRight /></span>
              </a>
            )}
