 ...
 */
export function LocationsPreview({ site = 'main' }: LocationsPreviewProps) {
  const { ref, isVisible } = useScrollAnimation()
  const locationsUrl = site === 'main' ? '/locations' : `${SITE_CONFIG.main.url}/locations`
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-0">
          ...
          >
            ...
            <div className="absolute -bottom-4 right-4 flex items-center gap-2 bg-white px-4 py-3 shadow-sm lg:-right-8 lg:bottom-8">
              ...
              <span className="text-xs uppercase tracking-widest text-[rgb(var(--color-navy))]" style={{ fontFamily: 'var(--font-raleway), system-ui, sans-serif', fontWeight: 500 }}>
          ...
          >
            ...
            <div className="mb-10 space-y-4">
              {locations.map((location, index) => (
                ...
                >
                  ...
                  <div>
                    <div className="text-sm text-[rgb(var(--color-navy))]" style={{ fontFamily: 'var(--font-raleway), system-ui, sans-serif', fontWeight: 500 }}>
                      {location.name}
                    </div>
            ...
            {site === 'main' ? (
              ...
              <a href={locationsUrl} className="btn-pill btn-pill-primary">
                <span className="btn-text">Get directions</span>
                <span className="btn-arrow"><ArrowRight /></span>
              </a>
            )}
