...
interface PageHeroProps {
  ...
  site?: SiteName
  /** 
   * CSS class for the image placeholder. Use img-placeholder-* classes from globals.css:
   * - img-placeholder (default gray)
   * - img-placeholder-gradient (navy to green)
   * - img-placeholder-warm (cream tones)
   * - img-placeholder-cool (breezy blue)
   * - img-placeholder-dark (dark navy)
   * - img-placeholder-organic (soft shapes)
   * - img-placeholder-geometric (pattern)
   * - img-placeholder-split (diagonal)
   * - img-placeholder-dots (dot pattern)
   */
  imageClass?: string
}

/**
 * Page Hero - Reusable hero for inner pages
 * 
 * Image styles are defined in globals.css as .img-placeholder-* classes
 */
