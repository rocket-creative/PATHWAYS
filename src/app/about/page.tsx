        ...
        <div className="container-site py-20 lg:py-28">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="flex flex-col justify-center lg:col-span-7">
              ...
              <div className="mt-8">
                <Link href={LINKS.wisdomTeam} className="btn-pill btn-pill-secondary">
        ...
        <div className="container-site py-20 lg:py-28">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link href={LINKS.start} className="btn-pill btn-pill-green">
                <span className="btn-text">Get Started Today</span>
                <span className="btn-arrow">
                  <ArrowRight />
                </span>
              </Link>
              <Link href={LINKS.contact} className="btn-pill btn-pill-white">
