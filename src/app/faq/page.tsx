...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Yes, we offer a limited number of sliding scale spots based on financial need and availability. If you are paying out of pocket and have concerns about affordability, we encourage you to speak with us directly. Our goal is to make therapy as accessible as possible.',
      },
      {
        q: 'How do you incorporate therapy and wellness in a collaborative treatment plan?',
        a: 'At Pathways Within, we believe true healing happens when the mind and body are supported together. Our therapy services focus on emotional insight, personal growth, and mental wellbeing, but we do not stop there. Through our 360 degree approach to care, we provide a truly holistic experience.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'At the beginning, we will meet once a week, more often if it is deemed therapeutically necessary, for as long as our therapeutic relationship feels beneficial to you. The work you are doing may grow or change, and the schedule you need may vary.',
      },
      {
        q: 'How long do sessions last?',
        a: 'Each therapy session will be one full hour. This is your hour and we are committed to showing up wholly to support the work you are so bravely doing.',
      },
      {
        q: 'What is your cancellation policy?',
        a: 'Appointments must be canceled 72 hours in advance. There will be a $75 fee for appointments canceled within the 72 hour window or missed without notice.',
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Therapists are people too! The benefit of talking to a therapist is the training and experience we have collected over the years. Friends can be a great source of support, but they are often unable to provide an unbiased and judgment free perspective.',
      },
      {
        q: 'How long do I have to be in therapy?',
        a: 'Therapy is meant to work for you, so that means we accommodate any preferences you may have. The length and frequency of therapy will depend on your goals and the effort you put forth. You get to decide and the process can be as flexible as you need.',
      },
      {
        q: 'How confidential is therapy?',
        a: 'Your privacy is a major ethical concern for us. We adhere to the guidelines set forth by the American Psychological Association (APA) and HIPAA. There are some limitations: if you express the intent to hurt a child, an elderly person, or yourself, we are required to report some information to relevant authorities.',
      },
      {
