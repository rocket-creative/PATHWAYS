...
import { LINKS } from '@/lib/site-urls'
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
            <div className="max-w-xl lg:col-span-6">
              ...
              <div className="flex flex-col items-start gap-5 sm:flex-row">
                <a href={LINKS.contact} className="btn-pill btn-pill-green">
        ...
        <div className="container-site py-20 lg:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-col items-center gap-5 sm:flex-row sm:justify-center">
              <a href={LINKS.contact} className="btn-pill btn-pill-white">
                <span className="btn-text">Book Free Consultation</span>
                <span className="btn-arrow">
                  <ArrowRight />
                </span>
            ...
            <p className="mt-4 text-sm text-white/50">
              ...
              <a href={LINKS.clientIntake} className="text-white underline hover:no-underline">
                intake form
              </a>
