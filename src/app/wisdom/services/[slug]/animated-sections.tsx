...
import { ArrowRight, Check, Clock, MapPin, Heart } from 'lucide-react'
        ...
        <div className="container-site section">
          ...
          >
            ...
            <div className="flex items-center justify-center">
              <div className="relative aspect-[3/2] w-full overflow-hidden rounded-2xl bg-gradient-to-br from-[rgb(var(--color-breezy))]/10 via-[rgb(var(--color-green))]/5 to-[rgb(var(--color-cream))] p-8 flex items-center justify-center">
                <div className="text-center">
                  <Heart className="mx-auto h-12 w-12 text-[rgb(var(--color-green))]/40 mb-4" />
                  <p className="text-[rgb(var(--color-navy))]/60 text-sm">Supporting your journey</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-site section">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {service.whatToExpect.map((step, index) => (
              <div 
                key={step} 
                className="group rounded-xl bg-white p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-white hover:to-[rgb(var(--color-linen))]/50 cursor-default"
                style={{ 
          ...
          <div className="container-site section">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {relatedServicesData.map((related, index) => (
                <Link
                  key={related.slug}
                  href={`/wisdom/services/${related.slug}`}
